...
class MyDatabaseHelper(private val context: Context?) :
    ...
    fun addBook(title: String?, author: String?, user: String?) {
        val db = this.writableDatabase
        val cv = ContentValues()
        cv.put(COLUMN_TITLE, title)
        cv.put(COLUMN_URL, author)
...
//            Toast.makeText(context, "Added Successfully!", Toast.LENGTH_SHORT).show()
    ...
    fun updateData(row_id: String, title: String?, author: String?, user: String?) {
        val db = this.writableDatabase
        val cv = ContentValues()
        cv.put(COLUMN_TITLE, title)
        cv.put(COLUMN_URL, author)
...
//            Toast.makeText(context, "Successfully Deleted.", Toast.LENGTH_SHORT).show()
    ...
    companion object {
        ...
        private const val COLUMN_USERAGENT = "book_user"
    }
}
