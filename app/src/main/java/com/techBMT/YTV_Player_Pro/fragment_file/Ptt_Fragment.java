...
public class Ptt_Fragment extends Fragment  implements IFragmentParent {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.fragment_ptt, container, false);
        return view;
    }
    ...
    private ArrayList<File> getPDFFile(String path) {
        ...
        if (directory.isFile() && directory.getName().contains(".ppt")) {
            list.add(directory);
            return list;
        }
    ...
    public void displayPDF() {
        recyclerView = view.findViewById(R.id.recycleView_ptt);
//        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
        pdfAdapter = new FileDocumentAdapter(getContext(), FileDocumentAdapter.DOCUMENT_TYPE.PPD);
    ...
    private void openPtt(final String path) {
        try {
