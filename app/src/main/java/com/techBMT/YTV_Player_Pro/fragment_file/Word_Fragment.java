...
public class Word_Fragment extends Fragment implements IFragmentParent {
    ...
    private ArrayList<File> getPDFFile(String path) {
        ...
        if (directory.isFile() && directory.getName().contains(".doc")) {
            list.add(directory);
            return list;
        }
    ...
    public void display() {
        recyclerView = view.findViewById(R.id.recycleView_word);
//        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
        pdfAdapter = new FileDocumentAdapter(getContext(), FileDocumentAdapter.DOCUMENT_TYPE.NOTE);
        ...
        pdfAdapter.setOnClickListener(new FileDocumentAdapter.OnClickListener() {
            ...
            public void onChooseItem(String path) {
                try {
                    Uri theUri = FileProvider.getUriForFile(getContext(), BuildConfig.APPLICATION_ID + ".provider", new File(path));
